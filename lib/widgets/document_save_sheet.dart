...
class DocumentSaveSheet extends StatefulWidget {
  ...
  const DocumentSaveSheet({
    super.key,
    required this.attachment,
    required this.initialName,
  });
  static Future<DocumentSaveData?> show(
    BuildContext context,
    PendingDocumentAttachment attachment,
    String initialName,
  ) => showModalBottomSheet<DocumentSaveData>(
    context: context,
    isScrollControlled: true,
    showDragHandle: true,
    builder: (_) =>
        DocumentSaveSheet(attachment: attachment, initialName: initialName),
  );
  @override
  State<DocumentSaveSheet> createState() => _DocumentSaveSheetState();
}
